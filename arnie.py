...
class Arnie(object):
    ...
    def __init__(self):
        ...
        self.video_orig = self.create_video_recorder('/home/pi/DeepPiCar/driver/data/car_video%s.avi' % datestr)
        self.video_lane = self.create_video_recorder('/home/pi/DeepPiCar/driver/data/car_video_lane%s.avi' % datestr)
